<template>
  ...
  >
    ...
    <div v-if="currentTab === 'login'" class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            >
            <div class="text-sm">
              <a href="#" class="font-semibold text-buttons hover:text-buttons"
                >Forgot password?</a
              >
            </div>
          </div>
    ...
    <div v-if="currentTab === 'register'" class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        <div>
          <label
            for="email"
        ...
        <div>
          ...
          <div class="mt-2">
            <input
              ...
              type="password"
              autocomplete="Please confirm your Username"
              required=""
              class="block w-full rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-buttons sm:text-sm sm:leading-6"
            />
          </div>
