    ...
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          ...
          <RouterLink to="/game" class="text-sm font-semibold leading-6 text-gray-900">Game</RouterLink>
          <RouterLink to="/store" class="text-sm font-semibold leading-6 text-gray-900">Store</RouterLink>
          <RouterLink to="/rankings" class="text-sm font-semibold leading-6 text-gray-900">Ranking</RouterLink>
        </PopoverGroup>
